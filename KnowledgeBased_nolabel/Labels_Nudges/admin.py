...
class EvaluateChoicesAdmin(admin.ModelAdmin):
    ...
    'know_many','recommend_recipe','many_to_choose','easy_choice','choice_overwhelming','sys_time','unders_sys','many_actions','understandability','effectiveness','nudge_eval','created')
    actions = [export_as_csv_action("CSV Export")]
