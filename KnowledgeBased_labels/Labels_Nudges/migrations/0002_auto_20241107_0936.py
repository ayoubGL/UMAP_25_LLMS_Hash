# Generated by Django 3.2.6 on 2024-11-07 08:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='evaluatechoices',
            name='satisfaction',
            field=models.CharField(choices=[(None, ''), ('Strongly_Disagree', 'Strongly Disagree'), ('Disagree', 'Disagree'), ('Neutral', 'Neutral'), ('Agree', 'Agree'), ('Strongly_Agree', 'Strongly Agree')], default=None, max_length=100, verbose_name='satisfaction'),
        ),
        migrations.AddField(
            model_name='evaluatechoices',
