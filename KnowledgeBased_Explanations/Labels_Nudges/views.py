...
#  Extract recipes
    ...
    # save recommendations
        ...
        h_recommendations.llm_nudges = [h_0_explanation,h_2_explanation,h_3_explanation]
        ...
        unh_recommendations.llm_nudges = [unh_0_explanation,unh_2_explanation,unh_4_explanation]
